...
obj = COIN;
```
This object has a number of [properties](#properties) that define features of the model (e.g., number of particles, model parameters) and the paradigm (e.g., perturbations, sensory cues). Some properties have default values, which can be overwritten.
