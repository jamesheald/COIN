...
The model was developed in MATLAB and has been tested on MATLAB R2020a. For Python users, please see the [Python version of COIN](https://github.com/changmin-yu/COIN_Python) developed by Changmin Yu.
