...
The COIN model can be fit either to an individual participants’ data or to group average data. Here, the group average case is presented, as an individual participant is a special case of a group with 1 member.
