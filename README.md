...
The COIN model can be fit either to an individual participants’ data or to group average data. Only the case of the group average is presented here, as an individual participant can be considered a group with 1 member.
