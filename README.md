...
The COIN model can be fit either to an individual participants’ data or to group average data. Here, the group average scenario is presented, as an individual participant can be considered a special case of a group with 1 member.
