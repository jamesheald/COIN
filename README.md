...
The COIN model can be fit either to an individual participants’ data or to the average data of a group. Here, the group average case is presented, as an individual participant is a special case of a group with 1 member.
