...
The COIN model can be fit either to an individual participants’ data or to group average data. The group average case is presented here, as an individual participant is just a group with 1 member.
