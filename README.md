...
- "[Lightspeed matlab toolbox](https://github.com/tminka/lightspeed)" by Tom Minka. To compile the mex files, **run install_lightspeed.m**.
- "[Nonparametric Bayesian Mixture Models - release 2.1](http://www.stats.ox.ac.uk/~teh/software.html)" by Yee Whye Teh. To compile the mex files, **run make.m**.
