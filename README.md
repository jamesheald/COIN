...
The COIN model can be fit either to an individual participants’ data or to group average data. Here, group average case is presented, as an individual participant can be considered a group with 1 member.
