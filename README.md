...
To plot specific variables or distributions, activate the relevant plotting flags in the properties of the object. If plotting a distribution, also specify the points to evaluate a distribution at. For example, to plot the distribution of the state of each context and the predicted probabilities:
```
