...
To calculate the negative log-likelihood for group average data, create an array of objects (one per participant). Use ([properties](#properties)) to define the model parameters, paradigm and adaptation data:
```
