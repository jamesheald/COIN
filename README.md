...
The COIN model can be fit either to an individual participants’ data or to group average data. Because an individual participant can be considered a group with 1 member, the group case is presented here.
