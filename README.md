...
o = obj.objective_COIN;
```
There are assumed to be an equal number of adaptation measurements per participant (the *i*-th average adaptation data point is the average *i*-th adaptation data point across participants).
