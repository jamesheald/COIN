...
To plot specific variables, activate the relevant plotting flags in the properties of the object. To plot distributions, also specify the points at which to evaluate a distribution at. For example, to plot the distribution of the state of each context and the predicted probabilities:
```
